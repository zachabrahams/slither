...
describe Slither::Parser do
  ...
  describe "when parsing sectionless input" do
    before(:each) do
      @definition = Slither.define :test, by_bytes: false, sectionless: true do |d|
        d.column :first, 10
        d.column :last, 10
      end
    ...
    it "should return an array when given multiple lines" do
      @io.string = "12345678900987654321\nabcdefghijjihgfedcba"

      expected = [
        {first: "1234567890", last: "0987654321"},
        {first: "abcdefghij", last: "jihgfedcba"},
      ]
